...
<a name="rhombile tiling">Rhombille tiling</a>
----------------------------------------------

We can get a single-color [Rhombille tiling](https://en.wikipedia.org/wiki/Rhombille_tiling) by using the "convex6" and a very narrow "star3" shape:
...
We can get a single-color [Tetrakis square tiling](https://en.wikipedia.org/wiki/Tetrakis_square_tiling) by using the "square" and a very narrow "star4" shape:
