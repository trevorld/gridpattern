...
test_that("tiling patterns work as expected", {
    ...
    expect_doppelganger("2*53.2**233.2*53.2**233", function()
        g.ppt("2*53.2**233.2*53.2**233", gp = gp3))
    ...
    expect_doppelganger("3.6*30.6**30", function()
        g.ppt("3.6*30.6**30", gp = gp3))
    expect_doppelganger("4.2*60.4.2**240", function()
        g.ppt("4.2*60.4.2**240", gp = gp3))
    expect_doppelganger("4.4*30.4**30", function()
        g.ppt("4.4*30.4**30", gp = gp2))
    expect_doppelganger("4.6.4*30.6", function()
        g.ppt("4.6.4*30.6", gp = gp3))
    ...
    expect_doppelganger("8.4*45.8.4*45", function()
        g.ppt("8.4*45.8.4*45", gp = gp2))
